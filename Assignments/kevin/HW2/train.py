...
def train(model, optimizer, loss_fn, data_iterator, metrics, params, num_steps):
    ...
    for i in t:
        ...
        train_batch, labels_batch = next(data_iterator) # Training batch from data loader
...
def train_and_evaluate(model, train_data, val_data, optimizer, loss_fn, metrics, params, model_dir, restore_file=None):
    ...
    if restore_file is not None:
        # TODO:  
        # Load checkpoint, use the function provided in utils
        p = f'{model_dir}/{restore_file}.pth.tar'
        utils.load_checkpoint(p, model, optimizer)
    ...
    for epoch in range(params.num_epochs):
        ...
        # TODO: DONE
        # Evaluate for one epoch on TRAINING set
        train_num_steps = (params.train_size + 1) // params.batch_size
        ...
        train(model, optimizer, loss_fn, train_data_iterator,
            metrics, params, train_num_steps)

        # TODO: DONE
        # Evaluate for one epoch on VALIDATION set
        val_num_steps = (params.val_size + 1) // params.batch_size
        val_data_iterator = data_loader.data_iterator(val_data, params, shuffle=True)
        # TODO: DONE
        # Use evaluate() function defined in evaluate.py
        val_metrics = evaluate(model, loss_fn, val_data_iterator, 
            metrics, params, val_num_steps)
...
if __name__ == '__main__':
    ...
    # instance of Adam optimizer for the model, with the learning rate specified in params
