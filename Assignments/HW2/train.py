...
def train(model, optimizer, loss_fn, data_iterator, metrics, params, num_steps):
    ...
    for i in t:
        ...
        train_batch, labels_batch = # (TODO) Training batch from data loader
...
def train_and_evaluate(model, train_data, val_data, optimizer, loss_fn, metrics, params, model_dir, restore_file=None):
    ...
    for epoch in range(params.num_epochs):
        ...
        num_steps = # TODO 
        train_data_iterator = # TODO 
        train(model, optimizer, loss_fn, train_data_iterator,
              metrics, params, num_steps)

        # Evaluate for one epoch on validation set
        val_data_iterator = # TODO
        val_metrics = # TODO, use evaluate() function defined in evaluate.py
...
if __name__ == '__main__':
    ...
    optimizer = # instance of Adam optimizer for the model, with the learning rate specified in params
